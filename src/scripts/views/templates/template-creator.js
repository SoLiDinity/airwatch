  ...
  screenWidth = 0,
    ...
    aqiColors,
            ...
            <div class="attributions">
                <p class="data-source">Data by: <a href="${
  data.attributions[0].url
}" target="_blank">${data.attributions[0].name}</a></p>
                <p class="data-source">Provided by: <a href="${
  data.attributions[1].url
}" target="_blank">${data.attributions[1].name}</a></p>
            </div>
        </div>
    </div>
    <div class="charts">
    <div class="aqi-chart-card general-aqi-chart shadow">
        ...
        <canvas id="aqisChart" width="${
  screenWidth < 700 ? 1 : screenWidth <= 900 ? 2 : 3
}" height="${screenWidth >= 1150 ? 1 : screenWidth > 900 ? 2 : 1}"></canvas>
...
const createBlogArticleTemplate = (articleData, currentBlogUrlToShare) => `
    ...
    <div class="share-links">
        <a class="share-link-button copy-to-clipboard" href="${
  window.location.href
}" id="copyToClipboard"><i class="fa-regular fa-copy"></i></a>
        <a class="share-link-button whatsapp" href="${
  currentBlogUrlToShare.wa
}" target="_blank"><i class="fa-brands fa-whatsapp"></i></a>
        <a class="share-link-button facebook" href="${
  currentBlogUrlToShare.fb
}" target="_blank"><i class="fa-brands fa-facebook-f"></i></a>
        <a class="share-link-button x-twitter" href="${
  currentBlogUrlToShare.tw
